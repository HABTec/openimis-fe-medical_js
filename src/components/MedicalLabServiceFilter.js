...
class MedicalLabServiceFilter extends Component {
      ...
      <ErrorBoundary>
        <section className={classes.form}>
          <Grid container>
            <ControlledField
              module="admin"
              id="medicalLabServiceFilter.code"
              field={
            ...
            <ControlledField
              module="admin"
              id="medicalLabServiceFilter.name"
              field={
                <Grid item xs={3} className={classes.item}>
                  <TextInput
                    module="medicalLabService"
          ...
          <Grid container justify="flex-end">
            <ControlledField
              module="admin"
              id="MedicalLabServiceFilter.showHistory"
              field={
...
export default withModulesManager(injectIntl(withTheme(withStyles(styles)(MedicalLabServiceFilter))));
